...
class RolesController extends AdminController implements RolesContract
{
    ...
    protected function setupMiddleware()
    {
        ...
        $this->middleware('antares.can:antares/acl::roles-list', ['only' => ['index'],]);
        $this->middleware('antares.can:antares/acl::edit-role', ['only' => ['show', 'edit'],]);
        $this->middleware('antares.can:antares/acl::create-role', ['only' => ['create', 'store'],]);
        $this->middleware('antares.can:antares/acl::delete-role', ['only' => ['delete', 'destroy'],]);
    }
    ...
    {
        set_meta('title', trans('antares/acl::title.roles.list'));
    ...
    {
        set_meta('title', trans('antares/acl::title.roles.create'));
        return view('antares/acl::roles.edit', $data);
    }
    ...
    {
        set_meta('title', trans('antares/acl::title.roles.update'));
        return view('antares/acl::roles.edit', $data);
    }
    ...
    public function storeFailed(array $error)
    {
        ...
        return $this->redirectWithMessage(handles('antares::acl/index/roles'), $message, 'error');
    }
    ...
    {
        $message = trans('antares/acl::response.roles.deleted', ['name' => $role->getAttribute('name')]);
        return $this->redirectWithMessage(handles('antares::acl/index/roles'), $message);
    }
