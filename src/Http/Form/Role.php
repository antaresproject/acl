...
namespace Antares\Acl\Http\Form;
    ...
    public function __construct(Model $model)
    {
        ...
        $grid->fieldset(function (Fieldset $fieldset) use($model) {
            ...
            $fieldset->control('button', 'cancel')
                    ->field(function() {
                        return app('html')->link(handles("antares::acl/index/roles"), trans('antares/foundation::label.cancel'), ['class' => 'btn btn--md btn--default mdl-button mdl-js-button']);
                    });
